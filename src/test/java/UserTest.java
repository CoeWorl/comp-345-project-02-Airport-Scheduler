...
//    }
    ...
    public void passengerTest(){
        ...
        assertThrows(Exception.class, () -> rebecca.addFlight("ab23"));
        assertThrows(Exception.class, () -> rebecca.removeFlight("ab23"));
        assertThrows(Exception.class, () -> rebecca.createSchedule("ab23"));
        assertThrows(Exception.class, () -> rebecca.randomSchedule("ab23", 1));
        assertThrows(Exception.class, () -> rebecca.getSchedule("ab23"));
        assertThrows(Exception.class, () -> rebecca.updateSchedule("ab23", new Schedule(rebecca.getFlight("ab23").getDeptTime(), jfk, terminal)));
        rebecca.addFlight("ab23");
